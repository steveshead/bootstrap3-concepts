...
$.backgroundVideo($('#bg-video'), {
		...
		"width": 846,
		"height": 476,
		"poster": "assets/video/street.jpg", // Change display image for video from here you want to use
		"path": "assets/video/",
		"filename": "street", // Change video from here you want to use
		"types": ["mp4", "ogv", "webm"]
});
...
// h2 first slide
$(".owl-item.active h2").addClass('animated fadeInRight');
$(".owl-item.active p").addClass('animated zoomIn');
...
function nextslide() {
$(".owl-item h2").removeClass('animated fadeInRight');
$(".owl-item p").removeClass('animated zoomIn');
}
